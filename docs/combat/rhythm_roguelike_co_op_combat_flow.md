...
- 系统对 4 条音轨分别评分（0–100）
- 得分映射为：
  - 总表达强度（根据统一设计：战斗不是对抗敌人，而是表达主导）
  - 总防御（表达稳定性）

音乐与战斗结算同步呈现。

**根据统一设计理念**：得分不是"攻击/防御"，而是"表达清晰度"和"表达稳定性"的体现。
...
- 【高光接管】
  - 收束回合中，你可以替代另一名玩家的表达不清晰判定（防止表达被淹没）

- 【结构兜底】
  - 若任一音轨低于阈值，你承受惩罚，但允许继续收束（保持表达清晰）

- 【延迟终止】
  - 满足收束条件时，可选择推迟 1 回合（等待更好的表达时机）
